...
const AsyncDemo = require("./AsyncDemo").default;
const FooterDemo = require("./FooterDemo").default;
const ConfirmDemo = require("./ConfirmDemo").default;
const MoreDemo = require("./MoreDemo").default;
          ...
          <Col span={span}>
            <div style={style}>
              ...
              <Demo
                ...
                desc={
                  "可以根据需要自定义页脚按钮，不需要页脚可设置footer 为 null"
                }
                demo={<FooterDemo />}
              ></Demo>
              <Demo
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"基础对话框"} href={"#modal-0"} />
                <Link title={"异步关闭"} href={"#modal-1"} />
                <Link title={"自定义页脚"} href={"#modal-2"} />
                <Link title={"确认对话框"} href={"#modal-3"} />
                <Link title={"信息提示"} href={"#modal-4"} />
              </Anchor>
            </Col>
          )}
        </Row>
