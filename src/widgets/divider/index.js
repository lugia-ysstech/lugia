...
const TypeDivider = require("./TypeDivider").default;
const PositionDivider = require("./PositionDivider").default;
const ContentDivider = require("./ContentDivider").default;
const VerticalDivider = require("./VerticalDivider").default;
          ...
          <Col span={span}>
            <div style={style}>
              ...
              <Demo
                ...
                desc={"可以配置显示在标题的左边，右边，默认居中显示"}
                demo={<PositionDivider />}
              ></Demo>
              <Demo
                title={"段落分割线"}
                titleID={"divider-2"}
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"风格"} href={"#divider-0"} />
                <Link title={"位置"} href={"#divider-1"} />
                <Link title={"段落分割线"} href={"#divider-2"} />
                <Link title={"垂直方向"} href={"#divider-3"} />
              </Anchor>
            </Col>
          )}
        </Row>
