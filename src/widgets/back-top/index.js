import  React from 'react';
        ...
        import back-top from '@lugia/lugia-web/dist/back-top/lugia.back-top.zh-CN.json';
        ...
        export default class ComDemo extends React.Component {
            render(){
                return(
                    <Row>
                        <Col span={20}>
                            <Title title={'BackTop 回到顶部'} subTitle={'BackTop'} desc={'返回页面顶部。'} />
                            ...
                            <EditTables dataSource={back-top} />
                        </Col>
                        <Col span={4}>
