...
const CustomDemo = require("./CustomDemo").default;
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"基本"} href={"#back-top-0"} />
                <Link title={"配置theme主题"} href={"#back-top-1"} />
                <Link title={"可自定义Dom"} href={"#back-top-2"} />
              </Anchor>
            </Col>
          )}
        </Row>
