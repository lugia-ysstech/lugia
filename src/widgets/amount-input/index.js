...
const BaseAmountInput = require("./BaseAmountInput").default;
const DisableAmountInput = require("./DisableAmountInput").default;
const DefaultValueAmountInput = require("./DefaultValueAmountInput").default;
const SizeAmountInput = require("./SizeAmountInput").default;
const PrefixAmountInput = require("./PrefixAmountInput").default;
const TransformAmountInput = require("./TransformAmountInput").default;
        ...
        <Row>
          <Col span={span}>
            <div style={style}>
              <Title
                title={"金额输入框"}
                subTitle={"AmountInput"}
                desc={"用于金额数字的填写,可切换人民币大小写显示效果."}
              />
              <Demo
                title={"基础用法"}
                titleID={"amount-input-0"}
                code={
                ...
                desc={"金额输入框基础用法"}
                demo={<BaseAmountInput />}
              ></Demo>
              <Demo
                title={"禁用状态"}
                titleID={"amount-input-1"}
                code={
                ...
                desc={"点击按钮切换金额输入框的禁用状态"}
                demo={<DisableAmountInput />}
              ></Demo>
              <Demo
                title={"默认值显示"}
                titleID={"amount-input-2"}
                code={
                ...
                desc={"金额输入框显示设置的默认值"}
                demo={<DefaultValueAmountInput />}
              ></Demo>
              <Demo
                title={"不同尺寸"}
                titleID={"amount-input-3"}
                code={
                ...
                desc={"有三种尺寸可以配置 高度分别为 40px、32px 和 24px。"}
                demo={<SizeAmountInput />}
              ></Demo>
              <Demo
                title={"不同的前缀 '¥'与 '$' "}
                titleID={"amount-input-4"}
                code={
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"基础用法"} href={"#amount-input-0"} />
                <Link title={"禁用状态"} href={"#amount-input-1"} />
                <Link title={"默认值显示"} href={"#amount-input-2"} />
                <Link title={"不同尺寸"} href={"#amount-input-3"} />
                <Link
                  title={"不同的前缀 '¥'与 '$' "}
                  href={"#amount-input-4"}
                />
                <Link title={"转换大小写"} href={"#amount-input-5"} />
              </Anchor>
            </Col>
          )}
        </Row>
