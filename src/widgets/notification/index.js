...
const DelayDemo = require("./DelayDemo").default;
          ...
          <Col span={span}>
            <div style={style}>
              ...
              <Demo
                ...
                desc={"自定义延时关闭通知提醒框，设置为0则不关闭"}
                demo={<DelayDemo />}
              ></Demo>
              <Demo
                title={"带图标"}
                titleID={"notification-2"}
                code={
                ...
                desc={"带有图标的通知提醒框，也可以自定义图标"}
                demo={<IconDemo />}
              ></Demo>
              <Demo
                title={"自定义方向"}
                titleID={"notification-3"}
                code={
                ...
                desc={
                  "自定义快速弹出对话框弹出方向，共左上、左下、右上、右下四个方向"
                }
                demo={<DirectionDemo />}
              ></Demo>
              <EditTables dataSource={NOTIFICATION} />
              <EditTheme dataSource={{ NOTIFICATION }} />
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"基础提醒框"} href={"#notification-0"} />
                <Link title={"自定义延时"} href={"#notification-1"} />
                <Link title={"带图标"} href={"#notification-2"} />
                <Link title={"自定义方向"} href={"#notification-3"} />
              </Anchor>
            </Col>
          )}
        </Row>
