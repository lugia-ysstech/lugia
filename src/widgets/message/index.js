          ...
          <Col span={span}>
            <div style={style}>
              ...
              <Demo
                ...
                desc={"可以自定义时间来控制全局提示的消失时间，默认为2秒"}
                demo={<DelayDemo />}
              ></Demo>
              <EditTables dataSource={MESSAGE} />
              <EditTheme dataSource={{ MESSAGE }} />
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"基础提示"} href={"#message-0"} />
                <Link title={"更多提示类型"} href={"#message-1"} />
                <Link title={"自定义时间"} href={"#message-2"} />
              </Anchor>
            </Col>
          )}
        </Row>
