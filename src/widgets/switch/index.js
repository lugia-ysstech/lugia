...
const BaseSwitch = require("./BaseSwitch").default;
const SizeSwitch = require("./SizeSwitch").default;
const DataSwitch = require("./DataSwitch").default;
const InverseSwitch = require("./InverseSwitch").default;
const DisabledSwitch = require("./DisabledSwitch").default;
const LoadingSwitch = require("./LoadingSwitch").default;
const OnfocusSwitch = require("./OnfocusSwitch").default;
          ...
          <Col span={span}>
            <div style={style}>
              ...
              <Demo
                ...
                desc={
                  "为开关配置文字和图标,通过属性displayFiled指定需要显示的文本,默认读取data中的text"
                }
                demo={<DataSwitch />}
              ></Demo>
              <Demo
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"基本"} href={"#switch-0"} />
                <Link title={"两种大小"} href={"#switch-1"} />
                <Link title={"文字和图标"} href={"#switch-2"} />
                <Link title={"开关翻转"} href={"#switch-3"} />
                <Link title={"禁用"} href={"#switch-4"} />
                <Link title={"加载"} href={"#switch-5"} />
                <Link title={"自动聚焦"} href={"#switch-6"} />
              </Anchor>
            </Col>
          )}
        </Row>
