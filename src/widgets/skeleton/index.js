...
const DefaultSkeleton = require("./DefaultSkeleton").default;
const ParagraphSkeleton = require("./ParagraphSkeleton").default;
const MultiSkeleton = require("./MultiSkeleton").default;
const AnimationSkeleton = require("./AnimationSkeleton").default;
const SwitchSkeleton = require("./SwitchSkeleton").default;
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"基本用法"} href={"#skeleton-0"} />
                <Link title={"只有段落的占位符"} href={"#skeleton-1"} />
                <Link title={"更复杂的占位符"} href={"#skeleton-2"} />
                <Link title={"带动画的占位符"} href={"#skeleton-3"} />
                <Link title={"包含子组件"} href={"#skeleton-4"} />
              </Anchor>
            </Col>
          )}
        </Row>
