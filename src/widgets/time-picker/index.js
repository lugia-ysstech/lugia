          ...
          <Col span={span}>
            <div style={style}>
              ...
              <Demo
                ...
                desc={
                  "使用format指定时间格式，格式的部分内容省略时，对应列也会消失"
                }
                demo={<FormatDemo />}
              ></Demo>
              <Demo
                title={"受控组件"}
                titleID={"time-picker-2"}
                code={
              ...
              <EditTheme dataSource={{ TIMEPICKER }} />
          ...
          {!isMobile && (
            <Col span={4}>
              <Anchor
                ...
                useHref={false}
              >
                <Link title={"基本"} href={"#time-picker-0"} />
                <Link title={"时间格式"} href={"#time-picker-1"} />
                <Link title={"受控组件"} href={"#time-picker-2"} />
                <Link title={"禁用"} href={"#time-picker-3"} />
              </Anchor>
            </Col>
          )}
        </Row>
